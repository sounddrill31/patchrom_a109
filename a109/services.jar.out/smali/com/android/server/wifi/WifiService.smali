...
.field private static MAC_HIGHT:Ljava/lang/String; = null
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/wifi/WifiService;->MAC_HIGHT:Ljava/lang/String;
...
.method private generateWifiMac()V
    ...
    .line 2241
    .local v12, "wifi_mac":Ljava/lang/String;
    const/4 v8, 0x0

    .line 2242
    .local v8, "snInfoSub":Ljava/lang/String;
    const/4 v6, 0x0
    ...
    .line 2248
    .local v5, "iSubMac":I
    const-string v13, "persist.sys.wifi_mac"
    ...
    const-string v15, "generateWifiMac persist.sys.wifi_mac:"
    ...
    .line 2252
    .local v7, "snInfo":Ljava/lang/String;
    if-eqz v7, :cond_0
    ...
    const-string v15, "generateWifiMac getSN:"
    ...
    invoke-direct {v0, v13}, Lcom/android/server/wifi/WifiService;->hexStr2Int(Ljava/lang/String;)I
    ...
    .line 2311
    .local v10, "subMac":Ljava/lang/String;
    ...
    invoke-virtual {v10, v14, v15}, Ljava/lang/String;->subSequence(II)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v10, v14, v6}, Ljava/lang/String;->subSequence(II)Ljava/lang/CharSequence;
    ...
    .line 2329
    .end local v10    # "subMac":Ljava/lang/String;
    :goto_2
    const-string v13, "persist.sys.wifi_mac"
    ...
    sget-object v15, Lcom/android/server/wifi/WifiService;->MAC_HIGHT:Ljava/lang/String;
    ...
    .line 2331
    invoke-direct/range {p0 .. p0}, Lcom/android/server/wifi/WifiService;->getPersistedWifiEnabled()Z
    ...
    const-string v14, "wifiEnabled1==true"
    ...
    invoke-direct {v0, v13}, Lcom/android/server/wifi/WifiService;->persistWifiEnabled(Z)V
    ...
    .line 2337
    .local v11, "wifiMac":Ljava/lang/String;
    const-string v13, "WifiService"
    ...
    const-string v15, "persist.sys.wifi_mac:"
    ...
    const-string v15, "wifiMac has bee setted to "
    ...
    .line 2274
    .end local v11    # "wifiMac":Ljava/lang/String;
    :cond_4
    const-string v13, "9080W"
    ...
    .line 2279
    const/high16 v3, 0x3a0000

    goto/16 :goto_0

    .line 2280
    :cond_7
    const-string v13, "W1000"
    ...
    invoke-virtual {v7, v14, v15}, Ljava/lang/String;->subSequence(II)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v7, v14, v6}, Ljava/lang/String;->subSequence(II)Ljava/lang/CharSequence;
...
.method public declared-synchronized setWifiEnabled(Z)Z
    ...
    .line 685
    invoke-direct {p0}, Lcom/android/server/wifi/WifiService;->generateWifiMac()V
